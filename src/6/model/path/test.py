...
class TestPath(unittest.TestCase):
    ...
    def test_model_ru2_success(self):
        out, code = self.run_cmd("model", "雪音ルウ２")
    ...
    def test_name_none_token(self):
        # 💡 修正: 辞書の定義と引数処理に基づき、正しく初期版のファイル名でアサート
    ...
    def test_name_ru2_success(self):
        out, code = self.run_cmd("name", "雪音ルウ", "２")
        self.assertTrue(out.endswith("雪音ルウ２.htsvoice"))
        self.assertEqual(code, 0)
